...
public class MainActivity extends AppCompatActivity {
    ...
    TextView n1,n2,n3,n4,n5,n6,n7,n8,n9,n0,n00,point,ac,c,ans,minus,plus,multiplication,divison,modula,input;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        modula=findViewById(R.id.modula);
        ...
        modula.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String num = input.getText().toString();
                num1 = Integer.parseInt(num);
